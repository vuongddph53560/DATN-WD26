...
function extractDevBrowserJWTFromURL(url) {
	...
	if (cleanUrl.href !== url.href && typeof globalThis.history !== "undefined") globalThis.history.replaceState(null, "", removeDevBrowserJwt(url));
	return jwt;
}
...
//# sourceMappingURL=devBrowser-tYnimKYY.mjs.map
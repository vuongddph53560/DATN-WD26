...
const ListRoom = () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='List room' subTitle='' />
      <p className='text-gray-500 mt-8'>All rooms</p>

      <div className='w-full max-w-3xl text-left border border-gray-300 rounded-1g max-h-80 overflow-y-scroll mt-3 '>

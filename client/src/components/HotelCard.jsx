...
const HotelCard = ({room, index}) => {
  return (
        <Link to={'/rooms/' + room._id} key={room._id} onClick={() => scrollTo(0,0)} className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05)] '>
            ...
            <div className='p-4 pt-5'>
                ...
                <div className='flex items-center justify-between mt-4'>
                    <p><span className='text-xl text-gray-800'>${room.pricePerNinght}</span>/night</p>

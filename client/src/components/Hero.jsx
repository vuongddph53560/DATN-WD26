...
const Hero = () => {
  return (
    ...
    md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
        ...
        <h1 className='front-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] front-bold md:front-extrabold max-w-xl mt-4'>Dicover Your Perfect Gateway Destination</h1>
